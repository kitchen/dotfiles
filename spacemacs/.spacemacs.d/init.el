...
(custom-set-variables
 ...
 '(org-attach-preferred-new-method (quote ask))
 ...
 '(package-selected-packages
   (quote
    (ac-ispell ace-jump-helm-line ace-link ace-window adaptive-wrap aggressive-indent alert anzu async auto-compile auto-complete auto-highlight-symbol auto-yasnippet avy bind-key bind-map bui clean-aindent-mode column-enforce-mode company company-go company-lsp company-statistics dap-mode dash dash-functional define-word diff-hl diminish dumb-jump editorconfig elisp-slime-nav epl eval-sexp-fu evil evil-anzu evil-args evil-ediff evil-escape evil-exchange evil-iedit-state evil-indent-plus evil-lisp-state evil-magit evil-matchit evil-mc evil-nerd-commenter evil-numbers evil-search-highlight-persist evil-surround evil-tutor evil-unimpaired evil-visual-mark-mode evil-visualstar exec-path-from-shell expand-region eyebrowse f fancy-battery fill-column-indicator flx flx-ido flycheck flycheck-pos-tip fringe-helper fuzzy gh gh-md gist git-commit git-gutter git-gutter+ git-gutter-fringe git-gutter-fringe+ git-link git-messenger git-timemachine gitattributes-mode gitconfig-mode github-browse-file github-clone github-search gitignore-mode gntp gnuplot go-eldoc go-guru go-mode go-snippets golden-ratio google-translate goto-chg hcl-mode helm helm-ag helm-c-yasnippet helm-company helm-core helm-descbinds helm-flx helm-gitignore helm-lsp helm-make helm-mode-manager helm-projectile helm-swoop helm-themes highlight highlight-indentation highlight-numbers highlight-parentheses hl-todo ht htmlize hungry-delete hydra iedit indent-guide link-hint linum-relative log4e logito lorem-ipsum lsp-mode lsp-python-ms lsp-treemacs lsp-ui lv macrostep magit magit-gh-pulls magit-gitflow magit-popup markdown-mode markdown-toc marshal mmm-mode move-text mwim neotree open-junk-file org-bullets org-category-capture org-download org-mime org-plus-contrib org-pomodoro org-present org-projectile orgit ox-pandoc packed pandoc-mode paradox parent-mode pcache pcre2el persp-mode pkg-info popup popwin pos-tip powerline projectile rainbow-delimiters request restart-emacs s smartparens smeargle solarized-theme spaceline spinner terraform-mode toc-org transient undo-tree unfill use-package uuidgen vi-tilde-fringe volatile-highlights which-key winum with-editor ws-butler yasnippet yasnippet-snippets )))
 '(paradox-github-token t)
