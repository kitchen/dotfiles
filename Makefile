...
symlinks = .bash_aliases .bash_profile .bashrc .gitconfig .hgrc .tmux.conf .vimrc .zshrc .zshrc.osx .vim .ssh/authorized_keys .ssh/config.d/ .ssh/is-osx .config/zsh .config/git .config/tmuxinator
